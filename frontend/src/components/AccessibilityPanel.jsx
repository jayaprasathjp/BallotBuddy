      ...
      {open && (
        ...
        >
          ...
          <div className="a11y-option">
            ...
            <div className="a11y-font-controls" role="group" aria-labelledby="font-size-label">
              <button className="a11y-font-btn" onClick={decreaseFontSize} aria-label="Decrease font size" disabled={fontScale <= 0.8}>A-</button>
              <button className="a11y-font-btn" onClick={resetFontSize} aria-label="Reset font size">A</button>
              <button className="a11y-font-btn" onClick={increaseFontSize} aria-label="Increase font size" disabled={fontScale >= 1.5}>A+</button>
            </div>
          </div>
          ...
          <button className="a11y-close" onClick={() => setOpen(false)} aria-label="Close accessibility panel">
            ✕ Close
          </button>
        </div>
      )}
