...
const SEED_TIMELINE = [
  {
    ...
    description: 'Election Commission announces election schedule and Model Code of Conduct comes into effect.',
    date: '2024-03-01',
    type: 'announcement',
    icon: '📢',
    completed: true,
  },
  {
    ...
    description: 'Candidates begin filing their nomination papers with the Returning Officer.',
    date: '2024-03-10',
    type: 'nomination',
    icon: '📝',
    completed: true,
  ...
  },
  {
    ...
    description: 'Returning Officer examines all nomination papers for eligibility.',
    date: '2024-03-18',
    type: 'scrutiny',
    icon: '🔍',
    completed: true,
  ...
  },
  {
    ...
    description: 'Active campaigning period. Candidates hold rallies and door-to-door campaigns.',
    date: '2024-03-21',
    endDate: '2024-04-17',
    type: 'campaign',
    icon: '📣',
  ...
  },
  {
    ...
    description: '48-hour silence period before polling. No campaigning allowed.',
    date: '2024-04-17',
    type: 'silence',
    icon: '🤫',
    completed: false,
  },
  {
    id: 'evt-008',
    title: 'Polling Day',
    description: 'Election Day! Eligible voters cast their votes at designated polling booths from 7 AM to 6 PM.',
    date: '2024-04-19',
    type: 'polling',
    icon: '🗳️',
    completed: false,
  ...
  },
  {
    id: 'evt-009',
    title: 'Vote Counting',
    description: 'EVM votes are counted at the counting center under strict security.',
    date: '2024-06-04',
    type: 'counting',
    icon: '🔢',
    completed: false,
...
router.get('/', async (req, res) => {
  try {
    ...
    res.json({ success: true, events: SEED_TIMELINE, total: SEED_TIMELINE.length });
  }
});

// POST /api/timeline/reminder
router.post('/reminder', guestMiddleware, validators.reminder, async (req, res) => {
